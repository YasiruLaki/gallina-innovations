  ...
  return (
    <>
      <Link href="/" aria-label="Gallina Innovations Home">
        <div
          className={`fixed top-5 z-[50] transition-all duration-500 px-4 sm:px-8 md:px-16 ${
        ...
        <div className="flex items-center justify-end w-full">
          <div className="flex items-center gap-6">
            <button
              ...
              className="z-[30] flex items-center justify-center p-2 rounded-full cursor-pointer focus:outline-none"
            >
...
type WindowWithScroll = Window & {
  scrollToProjectCategory?: (section: string) => void;
};
